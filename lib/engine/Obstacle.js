...
class Obstacle{
    ...
    has_intersection(other) {
        ...
        let has_on_x = this._x <= other.x <= this._x + this._width ||
            this._x <= other.x + other.width <= this._x + this._width;

        let has_on_y = this._y <= other.y <= this._y + this._height||
            this._y <= other.y + other.height <= this._y + this._height;
