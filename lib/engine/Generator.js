...
class Generator {
    static random_obstacle() {
        ...
        return new Obstacle.Obstacle(width, height, randomItem(Object.values(Obstacle.OBST_TYPES_HEALTH)));
    }
    ...
    static new_tank(field_width, field_height) {
