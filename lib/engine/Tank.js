...
class Tank {
    ...
    die() {
        this.gun()['player'].leave_tank();
        delete this.gun()['player'];

        this.turret()['player'].leave_tank();
        delete this.turret()['player'];

        this.left_track()['player'].leave_tank();
        delete this.left_track()['player'];

        this.right_track()['player'].leave_tank();
    ...
    hurt(tank_part_str, damage) {
        if (tank_part_str === 'tank' || this.is_part_broken(this.part(tank_part_str))) {
